...
public class Sistema {
    ...
    private boolean exit = false, conta = false;
    private int opcao, remover, pag, parc = 0;
    private int qde_expresso=0, qde_capuccino=0, qde_leite_com_cafe=0, qde_cafes_tradicional=0, qde_leite=0, qde_latte=0, qde_de_itens=0;
    private double valor_expresso, valor_capuccino, valor_leite_com_cafe, valor_tradicional, valor_leite, valor_latte, valor_itens_vendidos=0;
    ...
    public void calcularPedido(){
        ...
        System.out.println("Quantidade de café expresso: "+qde_expresso+" ­ valor: R$"+valor_expresso);
        System.out.println("Quantidade de café capuccino: "+qde_capuccino+" ­ valor: R$"+valor_capuccino);    
        System.out.println("Quantidade de leite com café: "+qde_leite_com_cafe+ " ­ valor: R$"+valor_leite_com_cafe);
        System.out.println("Quantidade de café tradicional: "+qde_cafes_tradicional+" ­ valor: R$"+valor_tradicional);    
        System.out.println("Quantidade de leite: "+qde_leite+ " ­ valor: R$"+valor_leite);
        System.out.println();
        System.out.println("Quantidade de itens vendidos: "+ qde_de_itens + " ­ valor cafés vendidos: R$"+valor_itens_vendidos);
        System.out.println();
    }
